...
public class TrendReport {
	...
	public synchronized static Connection getFillo() throws Exception {
		if(connection==null){
	...
	public synchronized  static TestRecord findRecord(String suitName,String testName) throws Exception {
	...
	public synchronized static TestRecord addRecord(String suitName,String testName) throws Exception {
...
//			connection = null;
	...
	public synchronized static void updateRecord(String suitName,String testName, String buildName, String status) throws Exception {
