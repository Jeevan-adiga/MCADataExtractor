...
public class AppiumDriver extends RemoteWebDriver implements DriverReportListener {
	...
	public AppiumDriver(SauceOnDemandAuthentication auth,String host, Capabilities desiredCapabilities,
	...
	public static Process sauceConnect(){
		...
		SauceOnDemandAuthentication auth = AppiumDriver.getAuth();
		String args = "";
		Proxy proxy = WebManager.getProxySettings();
		if(proxy.getProxyType().equals(ProxyType.MANUAL)){
	...
	public static AppiumDriver trial() {
		//set authentication
//		String username = DriverSettings.getProperty( DriverSetting.SAUCE_USERNAME );
//		String accessKey = DriverSettings.getProperty( DriverSetting.SAUCE_ACCESS_KEY );
//		SauceOnDemandAuthentication auth = new SauceOnDemandAuthentication(username, accessKey);
		...
		AppiumDriver driver = new AppiumDriver(auth, host, capabilities, null);
		return driver;
	}
