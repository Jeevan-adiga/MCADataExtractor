...
<xsl:template match="root">
	...
	$( document ).ready(function() {
		...
		$( "div.box[id='summary']" ).find("span.expand:first").click();
...
<xsl:template match="test-scenario">
	...
	<div class="box" id="test-summary">
		<div class="header2"><span class="collapse" href="#">[-]</span>Test Execution Summary<span class="status"> | <xsl:choose>
		  ...
		  <xsl:when test=".//report[@status='Passed'] and (.//report[@status='No Run'] or .//test-case[not(.//report)] or .//test-step[not(.//report)])">
		  	<span class="passed">Passed</span><span class="norun"> with <b>No Run</b></span>
		  </xsl:when>
